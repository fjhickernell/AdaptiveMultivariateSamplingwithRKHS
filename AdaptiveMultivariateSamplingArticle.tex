...
To illustrate it is still a space-filling design,  we consider the following multivariate function
	\begin{equation}
	f: (x_1,x_2) \mapsto 
 \cos(x_1+x_2)\exp(x_1x_2)
	\end{equation}
	where $x_i \in [0,1], \  i=1,2$ ,which is plotted in Figure \ref{fig:ChengDuFun}. 
		
	\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/ChengDuFunPlot.eps} \qquad
		\includegraphics[height = 4cm]{ProgramsImages/Alg3_ChengDuFun_SpatialMatern_adapt_th_EmpBayes_theta_1.eps} 
	...
	\input{ProgramsImages/Alg3_Out_ChengDuFun_SpatialMatern_adapt_th_EmpBayes_theta_1.txt}

\end{example}


\begin{example}
\label{ex:CustChengDufun}
To illustrate it is still a space-filling design,  we consider the following multivariate function
	\begin{equation}
	f: (x_1,x_2) \mapsto 
 \cos(\alpha_1 x_1+\alpha_2 x_2)
	\end{equation}
	where $x_i \in [0,1], \  i=1,2$ and
	$\alpha_1 = 2 \pi$ and $\alpha_2 = 0.01$,which is plotted in Figure \ref{fig:ChengDuFun}. 
	
		\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/CustChengDuFun1Plot.eps}
		\caption{ \label{fig:ChengDuFun}}
	\end{figure}

	We apply Algorithm \ref{alg:adapttheta} to this example using the sequence of data sites described in \eqref{eq:FixedVDCDes} with $n_0=10$. We choose the the Mat\'ern kernel in \eqref{eq:MaternTheta}.
	
	\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/Alg3_CustChengDuFun1_Matern_adapt_th_EmpBayesAx_theta_01.eps} \qquad
	\includegraphics[height = 4cm]{ProgramsImages/CustChengDuFun1_MaternErrorPlot.eps}
		\caption{ \label{fig:ChengDuFunSpatialMatern}}
	\end{figure}


		
	\input{ProgramsImages/Alg3_Out_CustChengDuFun1_Matern_adapt_th_EmpBayesAx_theta_0.1.txt}

		
		We choose the generalization of the Mat\'ern kernel in \eqref{eq:MaternAB}.
		
	\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/Alg3_CustChengDuFun1_SpatialMatern_adapt_th_EmpBayesAx_theta_01.eps} \qquad
	\includegraphics[height = 4cm]{ProgramsImages/CustChengDuFun1_SpatialMaternErrorPlot.eps}
		\caption{ \label{fig:ChengDuFunSpatialMatern}}
	\end{figure}
	...
	\input{ProgramsImages/Alg3_Out_CustChengDuFun1_SpatialMatern_adapt_th_EmpBayesAx_theta_0.1.txt}
	
We also can choose 
	$\alpha_1 = 0.01$ and $\alpha_2 = 2\pi$,which is plotted in Figure \ref{fig:ChengDuFun}. 
	
		\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/CustChengDuFun2Plot.eps}
		\caption{ \label{fig:ChengDuFun}}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/Alg3_CustChengDuFun2_Matern_adapt_th_EmpBayesAx_theta_01.eps} \qquad
	\includegraphics[height = 4cm]{ProgramsImages/CustChengDuFun2_MaternErrorPlot.eps}
		\caption{ \label{fig:ChengDuFun2SpatialMatern}}
	\end{figure}


		
	\input{ProgramsImages/Alg3_Out_CustChengDuFun2_Matern_adapt_th_EmpBayesAx_theta_0.1.txt}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[height = 4cm]{ProgramsImages/Alg3_CustChengDuFun2_SpatialMatern_adapt_th_EmpBayesAx_theta_01.eps} \qquad
	\includegraphics[height = 4cm]{ProgramsImages/CustChengDuFun2_SpatialMaternErrorPlot.eps}
		\caption{ \label{fig:ChengDuFun2SpatialMatern}}
	\end{figure}

		
	\input{ProgramsImages/Alg3_Out_CustChengDuFun2_SpatialMatern_adapt_th_EmpBayesAx_theta_0.1.txt}
	
\[ 
 \begin{array}{rccccccc} 
\multicolumn{2}{l}{A_\infty = 0.50\qquad B_0 = 0.05\qquad \mT = (0.68, 0.67,\ldots, 0.63)\qquad n_0 = 10} \\ \hline 
\multicolumn{2}{l}{\text{Final } \theta = (3.5\text{E}-12, 3.8\text{E}{-}1, 1.8\text{E}{-}9, 3.7\text{E}{-}1)} \\ \hline 
\multicolumn{2}{l}{\text{Final } \alpha = (1.0\text{E}{-}2, 3.1\text{E}0, 1.0\text{E}{-}2, 3.1\text{E}0)} \\ \hline 
    & n &     &  67 \\ \hline 
\varepsilon &     & 1.0\text{E}{-}1 \\ \hline 
\errBd &     & 1.0\text{E}{-}1 \\ \hline 
\norm[\infty]{f - \APP(\mX,\by)} &     & 1.9\text{E}{-}2 \\ \hline 
\text{Ptwise Error Bound} &    \% & 100\% 
\end{array} 
 \]
 
 \[ 
 \begin{array}{rccccccc} 
\multicolumn{2}{l}{A_\infty = 0.50\qquad B_0 = 0.05\qquad \mT = (0.088, 0.37,\ldots, 0.73)\qquad n_0 = 10} \\ \hline 
\multicolumn{2}{l}{\text{Final } \theta = (3.5\text{E}{-}1, 6.0\text{E}-31, 2.8\text{E}{-}7, 3.6\text{E}{-}1)} \\ \hline 
\multicolumn{2}{l}{\text{Final } \alpha = (3.1\text{E}0, 1.0\text{E}{-}2, 1.0\text{E}{-}2, 3.1\text{E}0)} \\ \hline 
    & n &     &  63 \\ \hline 
\varepsilon &     & 1.0\text{E}{-}1 \\ \hline 
\errBd &     & 9.7\text{E}{-}2 \\ \hline 
\norm[\infty]{f - \APP(\mX,\by)} &     & 4.4\text{E}{-}2 \\ \hline 
\text{Ptwise Error Bound} &    \% & 100\% 
\end{array} 
 \]
 ...
 \[ 
 \begin{array}{rccccccc} 
\multicolumn{2}{l}{A_\infty = 0.50\qquad B_0 = 0.05\qquad \mT = (0.22, 0.53,\ldots, 0.81)\qquad n_0 = 10} \\ \hline 
\multicolumn{2}{l}{\text{Final } \theta = (3.7\text{E}{-}1, 7.7\text{E}-28, 3.8\text{E}{-}1, 1.2\text{E}{-}8)} \\ \hline 
\multicolumn{2}{l}{\text{Final } \alpha = (3.1\text{E}0, 1.0\text{E}{-}2, 3.1\text{E}0, 1.0\text{E}{-}2)} \\ \hline 
    & n &     &  66 \\ \hline 
\varepsilon &     & 1.0\text{E}{-}1 \\ \hline 
\errBd &     & 9.8\text{E}{-}2 \\ \hline 
\norm[\infty]{f - \APP(\mX,\by)} &     & 1.9\text{E}{-}2 \\ \hline 
\text{Ptwise Error Bound} &    \% & 100\% 
\end{array} 
 \]
