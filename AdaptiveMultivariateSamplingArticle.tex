...
\end{align}
\end{subequations}
This data-based error bound provides what is needed for our adaptive algorithm.
...
\subsection{What is $A_n$?}

$A_n$ is to reflect how well the design is. We consider to define $A_n$ as
