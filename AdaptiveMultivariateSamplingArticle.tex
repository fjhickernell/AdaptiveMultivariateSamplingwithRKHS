...
\begin{example}
	...
	\input{ProgramsImages/Alg1_Out_SimpleFun_Matern_adapt_th.txt}
	
	
	\begin{figure}[H]
		\centering
		\includegraphics[height = 4.5cm]{ProgramsImages/SimpleFunPlot.eps} \qquad
		\includegraphics[height = 4.5cm]{ProgramsImages/Alg1_SimpleFun_Matern_adapt_th.eps}
...
Algorithm \ref{alg:adaptsample} uses fewer data sites that Algorithm \ref{alg:basicadapt} while still satisfying the overall error bound \eqref{eq:DataErrBdB} as well also satisfying the pointwise error bound \eqref{eq:DataErrBdA}.
		...
		\input{ProgramsImages/Alg2_Out_SimpleFun_Matern_adapt_th.txt}
	
	
	\begin{figure}[H]
		\centering
		\includegraphics[height = 5.5cm]{ProgramsImages/Alg2_SimpleFun_Matern_adapt_th.eps}
...
\begin{example}
	...
	\input{ProgramsImages/Alg3_Out_SimpleFun_Matern_adapt_th.txt}
	
	
	\begin{figure}[H]
		\centering
		\includegraphics[height = 5.5cm]{ProgramsImages/Alg3_SimpleFun_Matern_adapt_th.eps}
...
To illustrate it is still a space-filling design,  we consider the following univariate function, which has a mean value near zero
 ...
 \exp(-6x)\sin(8x+0.1) - 0.1,  \qquad x \in [0,1],
	...
	\input{ProgramsImages/Alg3_Out_LeftPeakFun_Matern_adapt_th.txt}
...
\label{ex:compfun2}
	...
	\input{ProgramsImages/Alg3_Out_LeftPeakFun_SpatialMatern_adapt_th.txt}
