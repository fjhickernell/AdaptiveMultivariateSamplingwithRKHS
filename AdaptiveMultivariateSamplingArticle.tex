...
\begin{example}
	...
	\input{ProgramsImages/AdaptAlgo1_Out_HigdonFun_GaussKernel_adapt_th_EmpBayesAx_theta_1.txt}\\
		\input{ProgramsImages/AdaptAlgo1_Out_HigdonFun_GaussKernel_adapt_th_EmpBayesAx_theta_0.txt}\\
	...
	\input{ProgramsImages/AdaptAlgo2_Out_HigdonFun_GaussKernel_adapt_th_EmpBayesAx_theta_0.txt}\\
...
But for Algorithm \ref{alg:adapttheta}, it can reach all the error tolerance $\varepsilon = 1E-5$ with 25 points.
	...
	\input{ProgramsImages/AdaptAlgo3_Out_HigdonFun_GaussKernel_adapt_th_EmpBayesAx_theta_1.txt}
		\input{ProgramsImages/AdaptAlgo3_Out_HigdonFun_GaussKernel_adapt_th_EmpBayesAx_theta_0.txt}
\end{example}
